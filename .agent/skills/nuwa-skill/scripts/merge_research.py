...
示例:
    python3 merge_research.py .agent/skills/elon-musk-perspective
...
def main():
    ...
    total_markers = total_primary + total_secondary
    primary_ratio = f"{total_primary}/{total_markers}" if total_markers > 0 else "未标记"
